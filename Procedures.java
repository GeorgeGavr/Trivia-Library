...
/*
	public void setQuest() {
		...
		while (true) {
			while (true)
				try {
					noOfQuestions = Integer.parseInt(keyInp.nextLine());
					break;
...
*/
	         ...
	         // Handle cancel or close
	            ...
	            try {
	                ...
	                if (noOfQuestions > 0 && noOfQuestions <= 50) {
	                    JOptionPane.showMessageDialog(null, 
	                            "You set " + noOfQuestions + " questions.", 
	                            "Success", 
	...
	public void setType() {
		...
		int chType =JOptionPane.showOptionDialog(
				null,
...
/*
	        ...
	        String[] categoryOptions = categoryNames.toArray(new String[0]);
	 ...
	 */
	        try {
	            ...
	            String selectedCategory = (String) JOptionPane.showInputDialog(
	                    ...
	                    null,
	                    categoryNames,
	                    categoryNames[0] // Default selection
	            );
